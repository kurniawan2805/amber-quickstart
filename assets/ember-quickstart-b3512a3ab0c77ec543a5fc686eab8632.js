...
r.map(function(){this.route("scientists"),this.route("programers")})
var a=r
e.default=a}),define("ember-quickstart/routes/programers",["exports"],function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t=Ember.Route.extend({model:function(){return["Siapa","Nama","Anjen"]}})
...
var t=Ember.HTMLBars.template({id:"0KKpGYK8",block:'{"symbols":["person"],"statements":[[7,"h2"],[9],[1,[22,0,["title"]],false],[10],[0,"\\n\\n"],[7,"ul"],[9],[0,"\\n"],[4,"each",[[22,0,["people"]]],null,{"statements":[[0,"  "],[7,"li"],[9],[1,[22,1,[]],false],[3,"action",[[22,0,[]],"showPerson",[22,1,[]]]],[10],[0,"\\n"]],"parameters":[1]},null],[10]],"hasEval":false}',meta:{moduleName:"ember-quickstart/templates/components/people-list.hbs"}})
e.default=t}),define("ember-quickstart/templates/programers",["exports"],function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t=Ember.HTMLBars.template({id:"e72Df3Uk",block:'{"symbols":[],"statements":[[1,[27,"people-list",null,[["title","people"],["List of Programmers",[22,0,["model"]]]]],false],[0,"\\n"],[1,[21,"outlet"],false]],"hasEval":false}',meta:{moduleName:"ember-quickstart/templates/programers.hbs"}})
...
var t=Ember.HTMLBars.template({id:"cQpQpFY8",block:'{"symbols":[],"statements":[[1,[27,"people-list",null,[["title","people"],["List of Scientists",[22,0,["model"]]]]],false]],"hasEval":false}',meta:{moduleName:"ember-quickstart/templates/scientists.hbs"}})
...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(a){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("ember-quickstart/app").default.create({name:"ember-quickstart",version:"0.0.0+120802ec"})
